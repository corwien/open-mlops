...
from mlopskit.io.core import (AbstractVersionedDataSet,get_protocol_and_path,
                              DataSetError,Version,get_filepath_str,AbstractDataSet)
...
data_set = APIDataSet(
    method="POST",
    url="http://54.214.110.168:8990/predict/onlinereco",
    json={"topN":14,"experiment":"gd_recom_mostpop","uid":"10000007","alternative":"userliked"}
)
data = data_set.load()
"""