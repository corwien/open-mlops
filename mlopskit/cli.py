...
from mlopskit import ModelLibrary
from mlopskit.api import create_mlopskit_app
from mlopskit.assets.cli import assets_cli
from mlopskit.core.errors import ModelsNotFound
from mlopskit.core.library import download_assets
from mlopskit.core.model_configuration import list_assets
from mlopskit.utils.serialization import safe_np_dump
...
def memory(models, required_models):
    """
    Show memory consumption of mlopskit models.
    """
...
@mlopskit_cli.command("list-assets")
@click.argument("models", type=str, nargs=-1, required=False)
@click.option("--required-models", "-r", multiple=True)
...
@mlopskit_cli.command("tf-serving")
...
@mlopskit_cli.command("download-assets")
@click.argument("models", type=str, nargs=-1, required=False)
@click.option("--required-models", "-r", multiple=True)
