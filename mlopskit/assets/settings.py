...
from mlopskit.assets.versioning.major_minor import MajorMinorAssetsVersioningSystem
from mlopskit.assets.versioning.simple_date import SimpleDateAssetsVersioningSystem
from mlopskit.assets.versioning.versioning import AssetsVersioningSystem
...
class AssetSpec:
    ...
    def __init__(
        ...
        versioning = (
            versioning
            or os.environ.get("MLOPSKIT_ASSETS_VERSIONING_SYSTEM")
            or "major_minor"
        )
