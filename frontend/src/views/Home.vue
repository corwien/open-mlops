  ...
  <el-row class="container">
    <el-col :span="24" class="header">
      <el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
            <router-link to="/dashboard" style='text-decoration: none;color: #FFFFFF;'>{{collapsed?'':sysName}}</router-link>
      </el-col>
      <el-col :span="10">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover"><!--<img :src="this.sysUserAvatar"-->
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
                <router-link :to="{name: '设置'}" style='text-decoration: none;color: #000000;'>我的消息</router-link>
            </el-dropdown-item>
            <el-dropdown-item>
            <router-link :to="{name: '设置'}" style='text-decoration: none;color: #000000;'>我的设置</router-link>
            </el-dropdown-item>
    ...
    <el-col :span="24" class="main">
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        <!--导航菜单-未折叠 $route.path-->
        <el-menu :default-active="defaultPath" class="el-menu-vertical-demo" @open="handleopen" @close="handleclose"
                 @select="handleselect" exact
...
<section class="content-container">
  <div class="grid-content bg-purple-light">
    <el-col :span="24" class="breadcrumb-container">
      <strong class="title" v-if="$route.name!='模型市场'">{{$route.name}}</strong>
